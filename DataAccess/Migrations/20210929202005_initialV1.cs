        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Biography = table.Column<string>(type: "nvarchar(180)", maxLength: 180, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFollowedTopics", x => new { x.UserId, x.TopicId });
                    table.ForeignKey(
                        name: "FK_UserFollowedTopics_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserFollowedTopics_Topics_TopicId",
                        column: x => x.TopicId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFollowedTopics_TopicId",
                table: "UserFollowedTopics",
                column: "TopicId");
        }
